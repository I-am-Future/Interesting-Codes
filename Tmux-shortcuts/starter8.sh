...
tmux split-window -h -t proj:0.1
tmux split-window -h -t proj:0.0

tmux split-window -h -t proj:0.4
tmux split-window -h -t proj:0.5
tmux split-window -h -t proj:0.4
...
tmux send-keys -t proj:0.4 'echo "Panel 5"; cd ~/.cache' C-m
tmux send-keys -t proj:0.5 'echo "Panel 6"; cd ~/.cache' C-m
tmux send-keys -t proj:0.6 'echo "Panel 7"; cd ~/.cache' C-m
tmux send-keys -t proj:0.7 'echo "Panel 8"; cd ~/.cache' C-m
